...
calibjsonpath = "/playback/calib.json"
...
calibgains = readcsv('/playback/Calibrations_final_speaker.csv')
...
class soundplayer:
    def __init__(self):
        ...
        self.mqttcertfolder="/playback/certs/"
        ...
        self.maskerpath = "/playback/maskers/"
        self.maskergain = 1.2
        self.gainweight = 1    
