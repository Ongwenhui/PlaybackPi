...
class soundplayer:
    def __init__(self):
        ...
        self.maskerpath = "/home/pi/maskers/alvintracks/"
        self.maskergain = 1
        self.gainweight = 15
        self.maskerdiff =0.5
        self.gainlimit = 10
        self.alvingain = args.Gain
        self.buffersize = 20
        self.blocksize = 4096
    ...
    def playmasker(self):
        ...
        try:
            with sf.SoundFile(self.maskerpath + self.currentmasker+'.wav') as f:
                print("stream created using {} with gain: {}".format(self.currentmasker,self.alvingain))
                ...
                with stream:
                    ...
                    for _ in range(int(self.buffersize)):
                        data = f.read(self.blocksize, always_2d=True)*self.alvingain
                        if not len(data):
                            break
